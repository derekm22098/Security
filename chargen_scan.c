// CHARGEN Scanner by DerekM ---> Quickly scan large IP ranges for Character Generator Protocols. For educational purposes and documenting poor security settings. --->  ---> OpenSource project @ FreeLightning.com
...
int main(int argc, char *argv[ ])
{
	...
	if(argc < 6){
		fprintf(stderr, "Invalid parameters!\n"); // CHARGEN Scanner by DerekM // Quickly scan large IP ranges for Character Generator Protocols. For educational purposes and documenting poor security settings.
