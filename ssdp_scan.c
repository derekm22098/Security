// SSDP Scanner by DerekM ---> Quickly scan large IP ranges for UPnP devices. For educational purposes and documenting poor security settings. --->  ---> OpenSource project @ FreeLightning.com
...
{
        if(argc < 6){
                fprintf(stderr, "Invalid parameters!\n"); // SSDP Scanner by DerekM // Quickly scan large IP ranges for SSDP. For educational purposes and documenting poor security settings.
