// DNS Scanner by DerekM  ---> Quickly scan large IP ranges for open DNS servers. For educational purposes only & Documenting poor security practices. ---> OpenSource project @ FreeLightning.com
    ...
    int main(int argc, char *argv[ ])
    {
            ...
            if(argc < 6){
                    fprintf(stderr, "Invalid parameters!\n"); // DNS Scanner by DerekM // Quickly scan large IP ranges for open DNS servers. For educational purposes and documenting poor security settings.
